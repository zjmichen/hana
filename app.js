...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TransformView = __webpack_require__(172);
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function transform() {
	      ...
	      var fromType = this.refs.before.state.type;
	      var toType = this.refs.after.state.type;
	      var data = '';

	      var loader = __webpack_require__(179)("./" + fromType + '/index');
	      ...
	      if (loader['to' + toType]) {
	        ...
	        var toLoader = __webpack_require__(193)("./" + toType);
	      ...
	      data.then(function (data) {
	        return _this2.setState({ output: data });
	      });
	    }
	  }, {
	    key: 'chooseFile',
	    value: function chooseFile() {
	      ...
	      _electron.ipcRenderer.on('choosefile', function (event, files) {
	        if (!files) return;
	        if (files.length === 0) return;
	        that.loadFile(files[0]);
	      });
	      _electron.ipcRenderer.send('choosefile');
	    }
	  }, {
	    key: 'loadFile',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TransformView = function (_React$Component) {
	  _inherits(TransformView, _React$Component);

	  function TransformView(props) {
	    _classCallCheck(this, TransformView);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TransformView).call(this, props));
	  ...
	  _createClass(TransformView, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'select',
	          { className: 'select', value: this.state.type, onChange: this.setType },
	          _react2.default.createElement(
	            'option',
	            { value: '', disabled: true },
	            'Select'
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./app-layout.less", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./app-layout.less");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html,\nbody,\n#root {\n  width: 100%;\n  height: 100%;\n  margin: 0;\n  padding: 0;\n}\n#root {\n  display: flex;\n  padding: 8px;\n  box-sizing: border-box;\n}\n#root *[class$=\"-layout\"] {\n  flex: 1;\n}\n.transform-view {\n  display: flex;\n  flex-direction: column;\n}\n.transform-view > .preview {\n  flex: 1;\n}\n.double-transform {\n  display: flex;\n}\n.double-transform > .transform-view {\n  flex: 1;\n}\n.double-transform > .divider {\n  padding: 4px;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n}\n.app-layout {\n  display: flex;\n  flex-direction: column;\n}\n.app-layout > .input {\n  margin-bottom: 8px;\n}\n.app-layout > .input > .filename {\n  margin-left: 8px;\n}\n.app-layout > .double-transform {\n  flex: 1;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var csv = __webpack_require__(181);

	module.exports = {
	  fromjson: function fromjson(input) {
	    return input;
	  },

	  tojson: function tojson(input) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	generate = __webpack_require__(182);

	parse = __webpack_require__(185);

	transform = __webpack_require__(187);

	stringify = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	stream = __webpack_require__(183);

	util = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var stringToPath = __webpack_require__(190);
